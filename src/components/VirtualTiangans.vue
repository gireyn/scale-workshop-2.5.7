  ...
  <svg width="100%" height="100%">
    ...
    >
      <rect
        ...
        rx="3"
      />
      <!-- Right edge (戊-keys: i%10==4) -->
      <line
        v-if="key.x % 10 === 4"
        :x1="((key.x + 1) * 100 / NUM_KEYS) + '%'"
        :y1="'8%'"
        :x2="((key.x + 1) * 100 / NUM_KEYS) + '%'"
        :y2="'92%'"
        stroke="rgb(255, 255, 255)"
        stroke-width="1.9"
        stroke-linecap="round"
      />
      <!-- Left edge (己-keys: i%10==5) -->
      <line
        v-if="key.x % 10 === 5"
        :x1="(key.x * 100 / NUM_KEYS) + '%'"
        :y1="'8%'"
        :x2="(key.x * 100 / NUM_KEYS) + '%'"
        :y2="'92%'"
        stroke="rgb(255, 255, 255)"
        stroke-width="1.9"
        stroke-linecap="round"
      />
      <!-- Right edge (乙-keys: i%10==1, 辛-keys: i%10==7) -->
      <line
        v-if="key.x % 10 === 1 || key.x % 10 === 7"
        :x1="((key.x + 1) * 100 / NUM_KEYS) + '%'"
        :y1="'8%'"
        :x2="((key.x + 1) * 100 / NUM_KEYS) + '%'"
        :y2="'92%'"
        ...
        stroke-linecap="round"
      />
      <!-- Left edge (丙-keys: i%10==2, 壬-keys: i%10==8) -->
      <line
        v-if="key.x % 10 === 2 || key.x % 10 === 8"
        :x1="(key.x * 100 / NUM_KEYS) + '%'"
        :y1="'8%'"
        :x2="(key.x * 100 / NUM_KEYS) + '%'"
        :y2="'92%'"
